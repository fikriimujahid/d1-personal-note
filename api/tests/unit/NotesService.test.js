...
const NotesService_1 = require("../../src/services/NotesService");
const NotesRepository_1 = require("../../src/repositories/NotesRepository");
...
describe('NotesService', () => {
    ...
    beforeEach(() => {
         ...
         */
        NotesRepository_1.NotesRepository.mockImplementation(() => mockRepositoryInstance);
        // Create the service we're testing
        service = new NotesService_1.NotesService();
    });
    /**
    ...
    describe('createNote', () => {
        ...
        it('should throw ValidationError if title is empty', async () => {
            ...
            await expect(service.createNote('user-123', {
                title: '',
    ...
    describe('getNote', () => {
        ...
        it('should throw NotFoundError if note does not exist', async () => {
            mockRepositoryInstance.get.mockRejectedValue(new errors_1.NotFoundError('Note not found'));
            await expect(service.getNote('user-123', 'nonexistent')).rejects.toThrow(errors_1.NotFoundError);
        });
    });
    /**
    ...
    describe('updateNote', () => {
        ...
        it('should throw ValidationError if updated title is empty', async () => {
            await expect(service.updateNote('user-123', 'n_test123', {
                title: '',
    ...
    describe('deleteNote', () => {
        ...
        it('should successfully delete a note', async () => {
             ...
             */
            expect(mockRepositoryInstance.delete).toHaveBeenCalledWith('user-123', 'n_test123');
        });
    });
});
/**
 ...
 * ═══════════════════════════════════════════════════════════════
 */ 
//# sourceMappingURL=NotesService.test.js.map